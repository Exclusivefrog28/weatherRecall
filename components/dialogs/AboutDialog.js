...
import { Dialog, Button, Text, List, Portal } from 'react-native-paper';
...
const AboutDialog = ({ isVisible, hide }) => {
    ...
    return (
        <Dialog visible={isVisible} onDismiss={hide}>
            ...
            <Dialog.Content >
                <Text style={styles.text1} variant="labelLarge">WeatherRecall 0.6{'\n'}Developed by Exclusivefrog28{'\n'}2022</Text>
...
const styles = new StyleSheet.create({
    ...
    text1: { alignSelf: 'center', fontSize: 16, marginBottom: 24 },
