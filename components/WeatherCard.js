...
const styles = new StyleSheet.create({
    ...
    card: { flex: 1, backgroundColor: 'transparent', marginVertical: 10 },
    ...
    subtitleText: { flex: 14, textAlign: 'left', textAlignVertical: 'center', fontSize: 14 },
    cardContent: { flexDirection: 'row', marginTop: 10 },
    mainInfo: { flex: 30, flexDirection: 'row', justifyContent: 'flex-start' },
    sideInfo: { flex: 21, justifyContent: 'center' },
    weatherText: { flex: 1, lineHeight: 32, fontSize: 28, bottom: 18, textAlignVertical: 'bottom' },
